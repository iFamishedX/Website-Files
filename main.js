...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-1', { style: 'fade-up', speed: 875, intensity: 2, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > *', state: true, replay: false });
		onvisible.add('.text-component.style-2', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.buttons-component.style-1', { style: 'pop-in', speed: 500, intensity: 1, threshold: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
